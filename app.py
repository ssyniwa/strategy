...
# --- 3. 究極のCSS修正（ここを全て上書きしてください） ---
st.markdown("""
<style>
    /* 1. ボタン本体のグレーを完全に消し、画像を最背面にセット */
    div.stButton > button {
        width: 100% !important;
    ...
    /* 2. 【重要】ボタンの内部にある「背景色を塗っている層」を透明化する */
    ...
    div.stButton p {
        ...
        text-shadow: 2px 2px 3px #000, -1px -1px 3px #000, 1px -1px 3px #000, -1px 1px 3px #000 !important;
        position: relative !important;
        z-index: 2 !important;
    }
</style>
